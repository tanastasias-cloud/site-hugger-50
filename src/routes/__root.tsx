...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Zertifiziertes Coaching in Berlin — für Privatpersonen, Unternehmen sowie Jobcenter- und Agentur-für-Arbeit-Kund:innen. AVGS & §16k SGB II anerkannt. DE · EN · UA · RU · PL." },
